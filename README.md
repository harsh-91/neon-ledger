...
- Version 1.3.4 is unsigned. Verify its published SHA-256 checksum while trusted code-signing approval is pending.
- Version 1.3.4 bypasses the generic Windows Setup close-applications stage and directly closes the old app before replacing its files; PostgreSQL data is preserved.
